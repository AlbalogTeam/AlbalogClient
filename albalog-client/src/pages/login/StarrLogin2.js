...
function StarrLogin2({ form, user, dispatchChangeField, dispatchSetUser }) {
  ...
  useEffect(() => {
    if (user.email) {
      ...
      history.push('/parttime/60ca0e7938caa500284f687c'); // 대쉬보드로 이동
      try {
...
export default connect(mapStateToProps, mapDispatchToProps)(StarrLogin2);
